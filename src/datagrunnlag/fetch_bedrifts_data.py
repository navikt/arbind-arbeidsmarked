...
Downloads Excel tables from nav.no for years 2021-2026 and produces:
  ...
  - sysselsettingsbarometer.csv   : Nasjonal tidsserie 2003–2026 (Tabell 3/4)
...
_EXCEL_URLS: dict[int, str] = {
    ...
    2026: "/_/attachment/download/4849fd6f-b3c8-4608-aab6-a30a14023370:d323c9fb1ebd14d3096a146aafcf3f890926b032/Navs%20bedriftsunders%C3%B8kelse%202026%20Figurer%20og%20tabeller.xlsx",
}
...
def main() -> None:
    ...
    # Use the 2026 file for the most complete time series (includes all prior years)
    df_barometer = _parse_barometer(2026)
