"""Genererer alle figurer og tabeller til rapportene (datagrunnlag, jobb og atid).

Lagrer filer til:
  quarto/datagrunnlag/figurer/  – PNG-figurer felles (stramhet, yrke, region)
  quarto/datagrunnlag/tabeller/ – CSV-tabeller felles (oversikt, geomap)
  quarto/stramhet/jobb/figurer/     – PNG-figurer (jobbindikator)
  quarto/stramhet/jobb/tabeller/    – CSV-tabeller (jobbindikator)
  quarto/stramhet/atid/figurer/     – PNG-figurer (atid-indikator)
...
_BEDRIFT_FIG = Path("quarto/datagrunnlag/figurer")
_BEDRIFT_TBL = Path("quarto/datagrunnlag/tabeller")
...
JOBB = ModeConfig(
    ...
    yunit="%",
    fig_dir=Path("quarto/stramhet/jobb/figurer"),
    tbl_dir=Path("quarto/stramhet/jobb/tabeller"),
)
...
ATID = ModeConfig(
    ...
    yunit="t/uke",
    fig_dir=Path("quarto/stramhet/atid/figurer"),
    tbl_dir=Path("quarto/stramhet/atid/tabeller"),
)
